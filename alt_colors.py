        ...
        for x in range(0,8):
            if (x+y) % 2 == 0:
                if piece != 0 and [x,y] in whites_coords and piece.color == 'black' and [x,y] in piece.move_possibilites():
                    ...
                    print(f'\033[37;42m{Pieces.whites[whites_coords.index([x,y])].emoji:^3} \033[m',end = '')
                elif [x,y] in blacks_coords:
                    print(f'\033[30;42m{Pieces.blacks[blacks_coords.index([x,y])].emoji:^3} \033[m',end = '')
                ...
                if piece != 0 and [x,y] in whites_coords and piece.color == 'black' and [x,y] in piece.move_possibilites():
                    ...
                    print(f'\033[37;43m{Pieces.whites[whites_coords.index([x,y])].emoji:^3} \033[m',end = '')
                elif [x,y] in blacks_coords:
                    print(f'\033[30;43m{Pieces.blacks[blacks_coords.index([x,y])].emoji:^3} \033[m',end = '')
                elif piece != 0 and [x,y] in piece.move_possibilites():
                    print(f'\033[37;46m    \033[m',end='')
                elif [x,y] not in pieces_coords:
                    print(f'\033[43m    \033[m',end='')
        print('')
